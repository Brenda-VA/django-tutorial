...
SECRET_KEY = 'django-insecure--tw^1mm2p+v&259x7n!8f-ps5(!0n$%p51+h13ev1cdvz2$^ro'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"], #le dice a Django busca templates en djangotutorial/templates/
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = "Europe/Madrid" #aqui se cambia la zona horaria
